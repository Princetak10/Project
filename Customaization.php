...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // if ($mysqli->query($sql) && $mysqli->query($sql1) && $mysqli->query($sql2) && $mysqli->query($sql3)&& $mysqli->query($sql4) && $mysqli->query($sql5)) {
    //     // Event and Food checkbox value successfully stored in the database
    //     echo "Event and Food checkbox value stored in the database.";
    // } else {
    //     // Error occurred while storing the event or checkbox value
